...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnBuildHead( oSettings )
		{
            ...
            // Plista Modification, if ColumnFilterWidget is enabled, replace header with our custom one
            if( !('oColumnFilterWidgets' in oSettings.oInit) ) {
            ...
            // Plista Modification, replace Header with custom one
            else {
                $(oSettings.nTHead).replaceWith( $.fn.dataTableExt.aoFeatures[0].fnInit(oSettings) );
            }
		...
		function _fnDraw( oSettings )
		{
			...
			else
			{
				...
				anRows[ writeIndex ] = document.createElement( 'tr' );

				if ( oSettings.asStripeClasses[0] )
				{
					anRows[ writeIndex ].className = oSettings.asStripeClasses[0];
				}

				var oLang = oSettings.oLanguage;
				var sZero = oLang.sZeroRecords;
                var classname = oSettings.oClasses.sRowEmpty;

				if ( oSettings.iDraw == 1 && oSettings.sAjaxSource !== null && !oSettings.oFeatures.bServerSide )
				{
					sZero = oLang.sLoadingRecords;
                    classname = "dataTables_loading";
				}
				...
				anRows[ writeIndex ].appendChild( nTd );
			}
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				else if ( DataTable.ext.aoFeatures.length !== 0 )
				{
					...
					{
                        if(aoFeatures[k].sFeature == "ColumnFilterWidgets") {
                            // fix to bring the ColumnFilterWidget inside Table
                            continue;
                        }
		...
		function _fnInitialise ( oSettings )
		{
			...
			if ( oSettings.sAjaxSource !== null && !oSettings.oFeatures.bServerSide )
			{
                ...
                oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aoData, function(json) {
                    ...
                    // Plista Modification, update our ColumnFilterWidget also
                    $(oSettings.nTHead).replaceWith( $.fn.dataTableExt.aoFeatures[0].fnInit(oSettings) );
