...
$data = $db->query("SELECT COUNT(impression.id) AS count FROM contest.impression, contest.item WHERE impression.item = item.id AND item.recommendable > 0 AND DATEDIFF(NOW(), impression.created) = 0");
